...
Artifact CORE_KIT_ARTIFACT           = new Artifact ("CoreKit",           CORE_KIT_NUGET_VERSION,           "12.0");
...
Artifact SHARE_KIT_ARTIFACT          = new Artifact ("ShareKit",          SHARE_KIT_NUGET_VERSION,          "12.0");
...
void SetArtifactsDependencies ()
{
	...
	//FACEBOOK_SDKS_ARTIFACT.Dependencies      = new [] { CORE_KIT_ARTIFACT, SHARE_KIT_ARTIFACT };
